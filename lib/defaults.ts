...
export const DEFAULT_GUESTS: Guest[] = [
  { id: '1', name: 'María García', contact: 'maria@email.com', rsvp: 'Sí', table_name: 'Mesa 1', seat: 0, menu: 'Normal', group: 'Familia García', avoid: [], address: '', thanked: false, events: [] },
  { id: '2', name: 'Carlos López', contact: '600 123 456', rsvp: 'Sí', table_name: 'Mesa 1', seat: 1, menu: 'Vegetariano', group: 'Amigos', avoid: [], address: '', thanked: false, events: [] },
  { id: '3', name: 'Ana Martínez', contact: '', rsvp: 'Pendiente', table_name: null, seat: null, menu: '', group: 'Amigos', avoid: [], address: '', thanked: false, events: [] },
]
