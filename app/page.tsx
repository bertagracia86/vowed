      ...
      <footer style={{ background: BLUE_LIGHT, borderBottomLeftRadius: 24, borderBottomRightRadius: 24 }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '64px 64px 40px', display: 'grid', gridTemplateColumns: '1.3fr 1fr 1fr 1.3fr', gap: 40 }}>
          ...
          <div>
            ...
            <Link href="/start" style={{ fontFamily: F, fontSize: 11, letterSpacing: '0.1em', textTransform: 'uppercase', color: BLUE_DARK, border: `1px solid ${BLUE_DARK}`, padding: '13px 26px', textDecoration: 'none', display: 'inline-block' }}>Empezar ahora</Link>
          </div>
        </div>
